...
import es.adevinta.spain.friends.integrationTests.acceptance.FriendshipFeatureHandler
...
class ApplicationIntegrationTest {
  ...
  @Nested
  inner class FriendshipHandlerFeatureNested : FriendshipFeatureHandler()
